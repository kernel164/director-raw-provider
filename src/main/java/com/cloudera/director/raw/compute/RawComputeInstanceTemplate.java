...
public class RawComputeInstanceTemplate extends ComputeInstanceTemplate {
  ...
  private static final List<ConfigurationProperty> CONFIGURATION_PROPERTIES =
      ConfigurationPropertiesUtil.merge(
          ...
          ConfigurationPropertiesUtil.asConfigurationPropertyList(
              RawComputeInstanceTemplateConfigurationPropertyToken.values())
      );
  ...
  public RawComputeInstanceTemplate(String name,
    ...
    String hostGroupExpressions = configuration.getConfigurationValue(
        RawComputeInstanceTemplateConfigurationPropertyToken.PREFERRED_HOSTS, localizationContext);
