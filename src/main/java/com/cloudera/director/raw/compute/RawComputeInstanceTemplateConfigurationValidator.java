...
public class RawComputeInstanceTemplateConfigurationValidator implements ConfigurationValidator {

  /**
   * The BYON compute provider.
   */
  private final RawComputeProvider provider;
   ...
   */
  public RawComputeInstanceTemplateConfigurationValidator(RawComputeProvider provider) {
